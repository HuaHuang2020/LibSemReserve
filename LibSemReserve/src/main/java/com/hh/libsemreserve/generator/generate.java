package com.hh.libsemreserve.generator;
...
public class generate {
    public static void main(String[] args) {
            //这里按着给的注解修改参数即可
            //手动配置数据源
            String url="jdbc:mysql://localhost:3306/lsr?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false";   //注意修改数据库名
            String name="root";
            String password="525757";

            //数据库表的设置
            List<String> listTable = Arrays.asList("admin","news","repairrequest","reservation","reservationpolicy","room","roomtype","user");  //设置需要自动代码生成的表名
            ...
            String module = "hh.libsemreserve";   //模块包名
            ...
            FastAutoGenerator.create(url, name, password)
                    ...
                    .globalConfig(builder -> {
                        builder.author(author) // 设置作者名
                                .outputDir(System.getProperty("user.dir") + "/LibSemReserve/src/main/java")   //设置输出路径：项目的 java 目录下【System.getProperty("user.dir")意思是获取到项目所在的绝对路径】
                                .commentDate("2024-02-06 12:00:00")   //注释日期
